...
export default function OyuncuError({
    error,
    reset,
}: {
    ...
    return (
        <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-4">
            <div className="w-20 h-20 rounded-full bg-red-500/10 border border-red-500/20 flex items-center justify-center mb-6">
                <Clapperboard size={40} className="text-red-400" />
            </div>
            <h2 className="text-2xl font-bold text-white mb-2">Oyuncu bilgisi yüklenemedi</h2>
            <p className="text-muted mb-6 max-w-md">
                {error.message || "Oyuncu bilgileri alınırken bir hata oluştu."}
            </p>
